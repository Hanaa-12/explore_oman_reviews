...
export default function Mosques() {
  ...
  const sortHigh = () => {
    setSorted([...mosques].sort((a, b) => b.averageRating - a.averageRating));
  };

  const sortLow = () => {
    setSorted([...mosques].sort((a, b) => a.averageRating - b.averageRating));
  };
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <span style={styles.badge}>MOSQUES</span>

        <h1 style={styles.title}>
          Discover Oman <span style={styles.titleSpan}>Mosques</span>
        </h1>

        <p style={styles.subtitle}>
          Explore beautiful mosques around Oman, check ratings, and discover
          peaceful places with unique Islamic architecture.
        </p>
      </div>
            ...
            sorted.map((item) => (
              <Col md="12" key={item._id}>
                <Card className="d-flex flex-row align-items-center p-3" style={styles.card}>
                  ...
                  >
                    <div>
                      <h5 style={styles.mosqueName}>{item.name}</h5>
