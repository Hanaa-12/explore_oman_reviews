...
export default function AddAttraReview() {
  const { id } = useParams();
  ...
  const styles = {
    page: {
      minHeight: "100vh",
      background: "linear-gradient(135deg, #f7f1e8 0%, #ead9c2 60%, #c9a46f 100%)",
      paddingBottom: "70px",
    },
    wrapper: {
      display: "flex",
    ...
    title: { textAlign: "center", color: "#2b2118", fontWeight: "800", marginBottom: "28px", fontSize: "30px" },
    label: { color: "#3b2a1d", fontWeight: "700", marginBottom: "8px" },
    input: {
      borderRadius: "18px",
        ...
        <Card style={styles.card}>
          <CardBody style={styles.cardBody}>
            <div className="text-center">
              <span style={styles.badge}>ATTRACTION REVIEW</span>
            </div>
