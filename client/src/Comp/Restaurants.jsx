...
export default function Restaurants() {
    ...
    const sortHigh = () => {
        const sortedData = [...restaurants].sort((a, b) => b.averageRating - a.averageRating);
        setSorted(sortedData);
    };

    const sortLow = () => {
        const sortedData = [...restaurants].sort((a, b) => a.averageRating - b.averageRating);
        setSorted(sortedData);
    };

    const resetSort = () => {
        setSorted(restaurants);
    };
    ...
    const styles = {
        ...
        card: {
            ...
            borderColor: "rgba(150, 110, 65, 0.16)",
        },
        image: {
            width: "190px",
            height: "140px",
    ...
    return (
        <div style={styles.page}>
            ...
            <div style={styles.heroSection}>
                <span style={styles.badge}>RESTAURANTS</span>

                <h1 style={styles.title}>
                    Discover Oman <span style={styles.titleSpan}>Restaurants</span>
                </h1>

                <p style={styles.subtitle}>
                    Find beautiful restaurants around Oman, check ratings, and explore
                    the best places for your next visit.
                </p>
            </div>
                            ...
                            <Col md="12" key={item._id}>
                                <Card className="d-flex flex-row align-items-center p-3" style={styles.card}>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h5 style={styles.restaurantName}>{item.name}</h5>
