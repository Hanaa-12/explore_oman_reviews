...
export default function Hotels() {
    ...
    const handleSearch = () => {
        const filtered = hotels.filter(r =>
    ...
    const sortHigh = () => {
        const sortedData = [...hotels].sort((a, b) => b.averageRating - a.averageRating);
        setSorted(sortedData);
    };

    const sortLow = () => {
        const sortedData = [...hotels].sort((a, b) => a.averageRating - b.averageRating);
        setSorted(sortedData);
    };
    ...
    return (
        <div style={styles.page}>
            ...
            <div style={styles.heroSection}>
                <span style={styles.badge}>HOTELS</span>

                <h1 style={styles.title}>
                    Discover Oman <span style={styles.titleSpan}>Hotels</span>
                </h1>

                <p style={styles.subtitle}>
                    Explore comfortable hotels around Oman, check ratings, and find
                    the perfect place for your next stay.
                </p>
            </div>
                            ...
                            <Col md="12" key={item._id}>
                                <Card className="d-flex flex-row align-items-center p-3" style={styles.card}>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h5 style={styles.hotelName}>{item.name}</h5>

                                            <p style={styles.rating}>
                                                ⭐ {item.averageRating ? item.averageRating.toFixed(1) : "No rating"} / 5
                                            </p>
                                        </div>
