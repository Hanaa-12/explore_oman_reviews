...
export default function AddRestReview() {
  const { id } = useParams();
  ...
  const submitReview = async (e) => {
    ...
    try {
      await axios.post("https://explore-oman-reviews-ley9.onrender.com/reviews", data);
        ...
        <Card style={styles.card}>
          <CardBody style={styles.cardBody}>
            <div className="text-center">
              <span style={styles.badge}>RESTAURANT REVIEW</span>
            </div>
